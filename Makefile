...
OBJS = intr.o lib.o mc.o quarkim.o ser.o serpri.o quark.o pcic.o led.o ethim.o mii.o ioapic.o hstbr.o pit8254.o tmim.o tmimc.o
HOBJS = serout.o
...
tmim.o: tmim.s tmim.h
tmimc.o: tmimc.c tmim.h
